...
public class HydroLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LPAREN", "RPAREN", "LBRACE", "RBRACE", "LLIST", "RLIST", "ASSIGN", "DOT", 
			"COMMA", "AT", "SEMI", "COLON", "TILDE", "QUESTION", "LARROW", "RARROW", 
			"ARROWASSIGN", "DOUBLECOLONS", "INCREMENT", "DECREMENT", "AMPERSAND", 
	...
	public HydroLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "Hydro.g4"; }
